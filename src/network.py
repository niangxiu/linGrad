...
class Network(object):
    ...
    def __init__(self, sizes, generator=False, epsstar=1.0):
    ...
    def cost_derivative(self, output_activations, y):
        ...
        if self.obj_factor is not None: 
            return (output_activations-y) * self.obj_factor
        else: return output_activations-y
    ...
    def lingrad(self, training_data, mini_batch_size):
        random.shuffle(training_data)
        mini_batches = [training_data[k:k+mini_batch_size]
                    for k in xrange(0, (self.N1+self.N2)*mini_batch_size, mini_batch_size)]
        for i, mini_batch in enumerate(mini_batches):
            delta_b, delta_w = self.parameter_perturb(mini_batch)
